...
public class FightWindowController : BaseController
{
    ...
    private void SubscribeButtons()
    {
        ...
        _fightWindowViewInstance.AddCrimeButton.onClick.AddListener(() => ChangeCrime(true));
        _fightWindowViewInstance.MinusCrimeButton.onClick.AddListener(() => ChangeCrime(false));
    }
    ...
    private void ChangeDataWindow(int countChangeData, DataType dataType)
    {
        switch (dataType)
        {
            ...
            case DataType.Crime:
                _fightWindowViewInstance.CountCrimeText.text = $"Player Crime {countChangeData.ToString()}";
    ...
    protected override void OnDispose()
    {
        ...
        _fightWindowViewInstance.AddCrimeButton.onClick.RemoveAllListeners();
        _fightWindowViewInstance.MinusCrimeButton.onClick.RemoveAllListeners();
